      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            Create Beautiful
            <span className="block text-[#ffcc02]">
              Postcards
            </span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
            <div className="w-14 h-14 bg-yellow-100 rounded-xl flex items-center justify-center mb-6">
              <svg className="w-7 h-7 text-[#ffcc02]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Custom Designs</h3>
            <p className="text-gray-600">Create unique postcard designs with our easy-to-use design tools and templates.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Send Anywhere</h3>
            <p className="text-gray-600">Send your postcards to friends and family anywhere in Switzerland and beyond.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow">
            ...
            <p className="text-gray-600">Add personal messages and memories to make your postcards truly special.</p>
          </div>
        </div>

        <div className="bg-white rounded-3xl shadow-xl p-12 text-center">
          <h3 className="text-3xl font-bold text-gray-900 mb-4">Ready to create your first postcard?</h3>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already creating and sending beautiful postcards to their loved ones.
          </p>
          <Link
            href="/designs"
